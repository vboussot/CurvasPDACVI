...
def run():
    ...
    os.system("konfai PREDICTION -y --gpu 0 --config ./resources/Prediction_TS.yml --models ./resources/Model/M291.pt")
    os.system("konfai PREDICTION -y --gpu 0 --config ./resources/Prediction.yml --models ./resources/Model/FT_0.pt ./resources/Model/FT_1.pt ./resources/Model/FT_2.pt ./resources/Model/FT_3.pt ./resources/Model/FT_4.pt")
